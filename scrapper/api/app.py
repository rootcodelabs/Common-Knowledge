...
from api.models import (
    SpecifiedLinksScrapeTask,
    SitemapCollectScrapperTask,
    EntireSourceScrapperTask,
    UploadedFileTask,
    LinkToScrape,
    EditedMetadataTask,
    SpecifiedApiFilesScrapeTask,
)
from worker.tasks import (
    specified_links_scrapper_task,
    sitemap_collect_scrapper_task,
    entire_source_scrapped_task,
    uploaded_file_task,
    specified_api_files_scrapper_task,
)
